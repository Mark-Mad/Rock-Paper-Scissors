...
selectionArticle.addEventListener("click", (e) => {
    ...
    if (e.target.id) {
        userSelectImg.src = `./assets/${e.target.id}w.png`;
        userSelectImg.alt = `${e.target.id}`;
        userSelectImg.id = `youw`;
...
const createPcSelection = () => {
        ...
        pcSelectImg.src = `./assets/${pcRandom}w.png`
        pcSelectImg.id = `pcs`
        // pcRandom = "rock"
...
const calculateResult = () => {
    ...
    if (userSelectImg.alt == pcRandom) {
        ...
        if (userSelectImg.alt === "rock") {
            pcRandom === "paper" ? youLost(userSelectImg.alt) : youWin(pcRandom)
        }else if(userSelectImg.alt === "scissor") {
            pcRandom === "rock" ? youLost(userSelectImg.alt) : youWin(pcRandom)
        }else if(userSelectImg.alt === "paper") {
            pcRandom === "scissor" ? youLost(userSelectImg.alt) : youWin(pcRandom)
        }
    }
...
const youLost = (you) => {
    console.log(you)
        ...
        document.getElementById(`youw`).setAttribute('src', `./assets/${you}l.png`)
}
const youWin = (pcs) => {
    console.log(pcs)
        ...
        document.getElementById(`pcs`).setAttribute('src', `./assets/${pcs}l.png`)
}
